...
In the main paper we considered a collective noise scenario, using a single Lindblad operator, $
...
To produce the plots in Fig. \ref{densitypics} we used the previously
...
% \section{Extention to three dimensions}
