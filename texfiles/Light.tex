...
\end{align}
where $p_i = \dot{q_i}$ is the conjugate momentum for $q$. The Hamiltonian now takes the same form as the Hamiltonian for the simple harmonic osciallator. We proceed with quantization by analogy with the harmonic oscillator by promoting $p$ and $q$ to operators satisfying the communtation relations
\begin{align}
